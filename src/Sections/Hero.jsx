  ...
  return (
    <section className="w-full min-h-screen flex-col   flex xl:flex-row justify-center items-center gap-10 max-container font-montserrat ">
      <div className="relative xl:w-2/5 flex flex-col justify-start items-start w-full max-xl:padding-x pt-28">
        <p className="text-2xl  xl:bg-white xl:whitespace-nowrap text-coral-red rounded-full hover:scale-105  hover:text-red-500 transition-all">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          <br />
          <span className="mt-3 inline-block text-coral-red hover:text-emerald-500 hover:cursor-pointer transition-all ">
            NIKE{" "}
          </span>{" "}
          Shoes.
        </h1>
